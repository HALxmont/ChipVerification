...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pwm.autotvin.dat"
	set constFileTvOut       "pwm.autotvout.dat"
	set constFileHdlTvIn     "pwm.autohdltvin.dat"
	set constFileHdlTvOut    "pwm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

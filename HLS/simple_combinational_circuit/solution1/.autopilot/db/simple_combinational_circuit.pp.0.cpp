# 1 "simple_combinational_circuit/.apc/simple_combinational_circuit.cpp"
# 1 "simple_combinational_circuit/.apc/simple_combinational_circuit.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "simple_combinational_circuit/.apc/simple_combinational_circuit.cpp" 2

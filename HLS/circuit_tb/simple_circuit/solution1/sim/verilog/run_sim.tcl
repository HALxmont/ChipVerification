...
if {[file isfile simple_circuit.autotvin.dat]} {
	file delete -force simple_circuit.autotvin.dat
}

if {[file isfile simple_circuit.autotvout.dat]} {
	file delete -force simple_circuit.autotvout.dat
}

...
// tvout file define: "d"
#define AUTOTB_TVOUT_PC_d  "../tv/rtldatafile/rtl.simple_circuit.autotvout_d.dat"
...
extern void simple_circuit (
bool a,
bool b,
bool c,
bool* d);

void AESL_WRAP_simple_circuit (
bool a,
bool b,
bool c,
bool* d)
					...
					// bitslice(0, 0)
					{
						...
						// celement: d(0, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								if (&(d[0]) != NULL) // check the null address if the c port is array or others
								{
									d[i_0] = (d_lv0_0_0_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DFF_REG.autotvin.dat"
	set constFileTvOut       "DFF_REG.autotvout.dat"
	set constFileHdlTvIn     "DFF_REG.autohdltvin.dat"
	set constFileHdlTvOut    "DFF_REG.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

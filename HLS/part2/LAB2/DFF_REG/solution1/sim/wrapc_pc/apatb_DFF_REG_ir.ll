; ModuleID = '/home/mxmont/Documents/Universidad/TESIS/ChipVerification/HLS/part2/LAB2/DFF_REG/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int = type { i3 }

; Function Attrs: noinline
define void @apatb_DFF_REG_ir(i1 %d, %struct.ap_uint* %q) local_unnamed_addr #0 {
entry:
  %q_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %q, %struct.ap_uint* nonnull align 512 %q_copy1)
  call void @apatb_DFF_REG_hw(i1 %d, %struct.ap_uint* %q_copy1)
  call fastcc void @copy_out(%struct.ap_uint* %q, %struct.ap_uint* nonnull align 512 %q_copy1)
  ret void
}
...
declare void @apatb_DFF_REG_hw(i1, %struct.ap_uint*)

define void @DFF_REG_hw_stub_wrapper(i1, %struct.ap_uint*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %1)
  call void @DFF_REG_hw_stub(i1 %0, %struct.ap_uint* %1)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @DFF_REG_hw_stub(i1, %struct.ap_uint*)

...
$(ObjDir)/DFF_REF_TB.cpp_pre.cpp.tb.o : DFF_REF_TB.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling DFF_REF_TB.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/DFF_REG.cpp_pre.cpp.tb.o : DFF_REG.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling DFF_REG.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

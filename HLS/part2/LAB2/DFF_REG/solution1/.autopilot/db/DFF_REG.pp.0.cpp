...
# 2 "<built-in>" 2
# 1 "DFF_REG/DFF_REG.cpp" 2
# 1 "DFF_REG/DFF_REG.h" 1
...
# 4 "DFF_REG/DFF_REG.h" 2
# 2 "DFF_REG/DFF_REG.cpp" 2


__attribute__((sdx_kernel("DFF_REG", 0))) void DFF_REG(bool d, ap_uint<3> &q){
#pragma HLS INTERFACE ap_none port=d
# 4 "DFF_REG/DFF_REG.cpp"

#pragma HLS INTERFACE ap_none port=q
# 4 "DFF_REG/DFF_REG.cpp"

#pragma HLS TOP name=DFF_REG
# 4 "DFF_REG/DFF_REG.cpp"

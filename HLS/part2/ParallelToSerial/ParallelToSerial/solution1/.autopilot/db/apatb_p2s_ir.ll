; ModuleID = '/home/mxmont/Documents/Universidad/TESIS/ChipVerification/HLS/part2/ParallelToSerial/ParallelToSerial/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_p2s_ir(i1 %begin, %struct.ap_uint* nocapture readonly %data_in, i1* %start, i1* %end, i1* %data_out) local_unnamed_addr #0 {
entry:
  %start_copy = alloca i1, align 512
  %end_copy = alloca i1, align 512
  %data_out_copy = alloca i1, align 512
  call fastcc void @copy_in(i1* %start, i1* nonnull align 512 %start_copy, i1* %end, i1* nonnull align 512 %end_copy, i1* %data_out, i1* nonnull align 512 %data_out_copy)
  call void @apatb_p2s_hw(i1 %begin, %struct.ap_uint* %data_in, i1* %start_copy, i1* %end_copy, i1* %data_out_copy)
  call fastcc void @copy_out(i1* %start, i1* nonnull align 512 %start_copy, i1* %end, i1* nonnull align 512 %end_copy, i1* %data_out, i1* nonnull align 512 %data_out_copy)
  ret void
}
...
declare void @apatb_p2s_hw(i1, %struct.ap_uint*, i1*, i1*, i1*)

define void @p2s_hw_stub_wrapper(i1, %struct.ap_uint*, i1*, i1*, i1*) #5 {
entry:
  call void @copy_out(i1* null, i1* %2, i1* null, i1* %3, i1* null, i1* %4)
  call void @p2s_hw_stub(i1 %0, %struct.ap_uint* %1, i1* %2, i1* %3, i1* %4)
  call void @copy_in(i1* null, i1* %2, i1* null, i1* %3, i1* null, i1* %4)
  ret void
}

declare void @p2s_hw_stub(i1, %struct.ap_uint*, i1*, i1*, i1*)

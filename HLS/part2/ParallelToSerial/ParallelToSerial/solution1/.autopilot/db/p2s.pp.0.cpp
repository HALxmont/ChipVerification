...
# 2 "<built-in>" 2
# 1 "ParallelToSerial/p2s.cpp" 2
# 1 "ParallelToSerial/p2s.h" 1
...
# 3 "ParallelToSerial/p2s.h" 2
# 2 "ParallelToSerial/p2s.cpp" 2



__attribute__((sdx_kernel("p2s", 0))) void p2s(bool begin, ap_uint<4> data_in, bool &start, bool &end, bool &data_out){
#pragma HLS TOP name=p2s
# 5 "ParallelToSerial/p2s.cpp"

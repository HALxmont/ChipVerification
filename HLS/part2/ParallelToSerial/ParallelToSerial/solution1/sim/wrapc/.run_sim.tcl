...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "p2s.autotvin.dat"
	set constFileTvOut       "p2s.autotvout.dat"
	set constFileHdlTvIn     "p2s.autohdltvin.dat"
	set constFileHdlTvOut    "p2s.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

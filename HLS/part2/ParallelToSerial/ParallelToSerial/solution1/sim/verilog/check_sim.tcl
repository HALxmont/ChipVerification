...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.p2s.autotvin_begin_r.dat"
         "c.p2s.autotvin_data_in.dat"
         "c.p2s.autotvout_start_r.dat"
         "c.p2s.autotvout_end_r.dat"
         "c.p2s.autotvout_data_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.p2s.autotvout_start_r.dat"
         "rtl.p2s.autotvout_end_r.dat"
         "rtl.p2s.autotvout_data_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

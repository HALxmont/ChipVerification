...
`define AUTOTB_TVIN_begin_r  "../tv/cdatafile/c.p2s.autotvin_begin_r.dat"
`define AUTOTB_TVIN_data_in  "../tv/cdatafile/c.p2s.autotvin_data_in.dat"
`define AUTOTB_TVIN_begin_r_out_wrapc  "../tv/rtldatafile/rtl.p2s.autotvin_begin_r.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "../tv/rtldatafile/rtl.p2s.autotvin_data_in.dat"
`define AUTOTB_TVOUT_start_r  "../tv/cdatafile/c.p2s.autotvout_start_r.dat"
`define AUTOTB_TVOUT_end_r  "../tv/cdatafile/c.p2s.autotvout_end_r.dat"
`define AUTOTB_TVOUT_data_out  "../tv/cdatafile/c.p2s.autotvout_data_out.dat"
`define AUTOTB_TVOUT_start_r_out_wrapc  "../tv/rtldatafile/rtl.p2s.autotvout_start_r.dat"
`define AUTOTB_TVOUT_end_r_out_wrapc  "../tv/rtldatafile/rtl.p2s.autotvout_end_r.dat"
`define AUTOTB_TVOUT_data_out_out_wrapc  "../tv/rtldatafile/rtl.p2s.autotvout_data_out.dat"
module `AUTOTB_TOP;

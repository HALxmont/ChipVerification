...
# 2 "<built-in>" 2
# 1 "Counter/counter.cpp" 2

# 1 "Counter/counter.h" 1
...
# 3 "Counter/counter.h" 2
# 3 "Counter/counter.cpp" 2


typedef enum{wait_for_one, wait_for_zero} counter_state_type;


__attribute__((sdx_kernel("counter", 0))) void counter(bool sw, ap_uint<5> &number_out){
#pragma HLS TOP name=counter
# 8 "Counter/counter.cpp"

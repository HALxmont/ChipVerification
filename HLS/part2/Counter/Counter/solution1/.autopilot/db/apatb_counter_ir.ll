; ModuleID = '/home/mxmont/Documents/Universidad/TESIS/ChipVerification/HLS/part2/Counter/Counter/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int = type { i5 }

; Function Attrs: noinline
define void @apatb_counter_ir(i1 %sw, %struct.ap_uint* %number_out) local_unnamed_addr #0 {
entry:
  %number_out_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %number_out, %struct.ap_uint* nonnull align 512 %number_out_copy1)
  call void @apatb_counter_hw(i1 %sw, %struct.ap_uint* %number_out_copy1)
  call fastcc void @copy_out(%struct.ap_uint* %number_out, %struct.ap_uint* nonnull align 512 %number_out_copy1)
  ret void
}
...
declare void @apatb_counter_hw(i1, %struct.ap_uint*)

define void @counter_hw_stub_wrapper(i1, %struct.ap_uint*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %1)
  call void @counter_hw_stub(i1 %0, %struct.ap_uint* %1)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @counter_hw_stub(i1, %struct.ap_uint*)

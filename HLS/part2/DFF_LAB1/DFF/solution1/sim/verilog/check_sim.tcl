...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.DFF.autotvin_d.dat"
         "c.DFF.autotvout_q1.dat"
         "c.DFF.autotvout_q2.dat"
         "c.DFF.autotvout_q3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.DFF.autotvout_q1.dat"
         "rtl.DFF.autotvout_q2.dat"
         "rtl.DFF.autotvout_q3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

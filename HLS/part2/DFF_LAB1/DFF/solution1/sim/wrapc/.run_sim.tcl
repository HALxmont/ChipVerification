...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DFF.autotvin.dat"
	set constFileTvOut       "DFF.autotvout.dat"
	set constFileHdlTvIn     "DFF.autohdltvin.dat"
	set constFileHdlTvOut    "DFF.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

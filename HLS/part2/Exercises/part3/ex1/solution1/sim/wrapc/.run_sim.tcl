...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "global_variable.autotvin.dat"
	set constFileTvOut       "global_variable.autotvout.dat"
	set constFileHdlTvIn     "global_variable.autohdltvin.dat"
	set constFileHdlTvOut    "global_variable.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

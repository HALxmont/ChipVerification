...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.global_variable.autotvin_d.dat"
         "c.global_variable.autotvout_q1.dat"
         "c.global_variable.autotvout_q2.dat"
         "c.global_variable.autotvout_q3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.global_variable.autotvout_q1.dat"
         "rtl.global_variable.autotvout_q2.dat"
         "rtl.global_variable.autotvout_q3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

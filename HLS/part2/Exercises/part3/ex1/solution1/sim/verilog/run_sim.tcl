...
if {[file isfile global_variable.autotvin.dat]} {
	file delete -force global_variable.autotvin.dat
}

if {[file isfile global_variable.autotvout.dat]} {
	file delete -force global_variable.autotvout.dat
}

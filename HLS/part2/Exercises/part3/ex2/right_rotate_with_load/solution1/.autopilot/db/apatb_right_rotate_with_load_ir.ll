; ModuleID = '/home/mxmont/Documents/Universidad/TESIS/ChipVerification/HLS/part2/Exercises/part3/ex2/right_rotate_with_load/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_right_rotate_with_load_ir(%struct.ap_uint* nocapture readonly %data_in, i1 %load, i1 %rotate, %struct.ap_uint* %data_out) local_unnamed_addr #0 {
entry:
  %data_out_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %data_out, %struct.ap_uint* nonnull align 512 %data_out_copy1)
  call void @apatb_right_rotate_with_load_hw(%struct.ap_uint* %data_in, i1 %load, i1 %rotate, %struct.ap_uint* %data_out_copy1)
  call fastcc void @copy_out(%struct.ap_uint* %data_out, %struct.ap_uint* nonnull align 512 %data_out_copy1)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_uint* noalias, %struct.ap_uint* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_uint* noalias, %struct.ap_uint* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0struct.ap_uint(%struct.ap_uint* %0, %struct.ap_uint* align 512 %1)
  ret void
}

declare void @apatb_right_rotate_with_load_hw(%struct.ap_uint*, i1, i1, %struct.ap_uint*)

define void @right_rotate_with_load_hw_stub_wrapper(%struct.ap_uint*, i1, i1, %struct.ap_uint*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %3)
  call void @right_rotate_with_load_hw_stub(%struct.ap_uint* %0, i1 %1, i1 %2, %struct.ap_uint* %3)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %3)
  ret void
}

declare void @right_rotate_with_load_hw_stub(%struct.ap_uint*, i1, i1, %struct.ap_uint*)

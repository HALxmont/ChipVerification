# 1 "right_rotate_with_load/right_rotate_with_load.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "right_rotate_with_load/right_rotate_with_load.cpp" 2

# 1 "right_rotate_with_load/right_rotate_with_load.h" 1
...
# 4 "right_rotate_with_load/right_rotate_with_load.h" 2
# 3 "right_rotate_with_load/right_rotate_with_load.cpp" 2
__attribute__((sdx_kernel("right_rotate_with_load", 0))) void right_rotate_with_load(ap_uint<17> data_in, bool load, bool rotate, ap_uint<17> &data_out){
#pragma HLS TOP name=right_rotate_with_load
# 3 "right_rotate_with_load/right_rotate_with_load.cpp"



 static ap_uint<17> rotate_register = 0;

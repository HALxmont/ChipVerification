...
ISEStep( "vivado",
         "-log chip_test_env_discriminator_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chip_test_env_discriminator_counter_0_0.tcl" );

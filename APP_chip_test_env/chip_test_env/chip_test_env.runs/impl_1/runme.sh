...
HD_PWD='/home/mxmont/AXI_TESTS/Chip_test_env/chip_test_env/chip_test_env.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chip_test_env_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chip_test_env_wrapper.tcl -notrace

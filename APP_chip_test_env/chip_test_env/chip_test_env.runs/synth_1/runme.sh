...
HD_PWD='/home/mxmont/AXI_TESTS/Chip_test_env/chip_test_env/chip_test_env.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chip_test_env_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chip_test_env_wrapper.tcl

...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = chip_fsm_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = chip_fsm_controller_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = discriminator_counter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = discriminator_counter_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ADC_board
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ADC_board_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DAC_MODULE
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DAC_MODULE_0
END
